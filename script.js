$(document).ready(function(){
    $('#btnTambah').on('click',function(){
        const teksTugas = $('#inputTugas').val(); //Mengambil nilai id inputTugas
        const teksTanggal = $('#inputTanggal').val(); //Mengambil nilai id inputTanggal
        const listBaru = $('<li></li>'); //Membuat List Baru
        const checkbox = $('<input type="checkbox">'); //Menambahkan input Checkbox
        const containerTeks = $('<div style="flex: 1;"></div>'); //Menambahkan Container Teks
